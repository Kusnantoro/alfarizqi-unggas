                    ...
                    <div class="card mb-3">
                        <div class="row no-gutters shadow">
                            <div class="col-md-7 card-body">
                                ...
                                <h4 class="card-text">No ID Pelanggan : <b><i>{{ $pelanggan->id_pelanggan }}</i></b></h4>
                            ...
                            <div class="col-auto card-body">
                                ...
                                <h4 class="card-text">Kirim Notifikasi ke Pelanggan :
                                    <a
                                        href="https://wa.me/+62{{ $pelanggan->no_hp }}?text=Yth.%20Pelanggan%20Alfarizqi%20Unggas%0ABerikut%20adalah%20data%20perolehan%20poin%20Anda%20%3A%0ANama%20%3A%20{{ $pelanggan->nama }}%0ANo%20ID%20Pelanggan%20%3A%20{{ $pelanggan->id_pelanggan }}%0ANo%20HP%20%3A%200{{ $pelanggan->no_hp }}%0AAlamat%20%3A%20{{ $pelanggan->alamat }}%0ATotal%20Poin%20%3A%20{{ $pelanggan->poin }}%0AStatus%20%3A%20{{ $pelanggan->status == 'TUKAR' ? 'SUDAH DI TUKAR' : 'BELUM DI TUKAR' }}%0A%0ATerima%20kasih%20atas%20kepercayaan%20anda%20telah%20berbelanja%20di%20Alfarizqi%20Unggas.%0ATerus%20kumpulkan%20poin%20Anda%2C%20dan%20tukarkan%20dengan%20hadiah%20yang%20menarik." target="_blank"><img
